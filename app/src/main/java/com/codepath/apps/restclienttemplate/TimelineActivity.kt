...
class TimelineActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        rvTweets.addOnScrollListener(object : EndlessRecyclerViewScrollListener(rvTweets.layoutManager as LinearLayoutManager) {
        ...
        client.getHomeTimeline(params = params, handler = object : JsonHttpResponseHandler() {
            ...
            override fun onSuccess(statusCode: Int, headers: Headers, json: JSON) {
                ...
                try {
                    ...
                    val listOfNewTweetsRetrieved = Tweet.fromJsonArray(jsonArray)
                    tweets.addAll(listOfNewTweetsRetrieved)
                    adapter.notifyItemRangeInserted(tweets.size - listOfNewTweetsRetrieved.size, listOfNewTweetsRetrieved.size)
